...
public class LibraryFineCalculator extends JFrame implements ActionListener, MouseListener, KeyListener {

    JRadioButton ugBtn, pgBtn, scholarBtn, facultyBtn;
    ButtonGroup group;
